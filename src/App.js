...
const IconSearch  = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>;
const IconX       = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>;
const IconLocate  = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="3"/><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/></svg>;
const IconStar    = ({filled}) => <svg width="18" height="18" viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" aria-hidden="true"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>;
const IconClock   = () => <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>;
const IconAlert   = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>;
const IconDroplet = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/></svg>;
const IconWind    = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2"/></svg>;
const IconEye     = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>;
const IconGauge   = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>;
const IconCloud   = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></svg>;
const IconAir     = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M3 12h18M3 6l9-4 9 4M3 18l9 4 9-4"/></svg>;
const IconRain    = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><line x1="8" y1="19" x2="8" y2="21"/><line x1="8" y1="13" x2="8" y2="15"/><line x1="16" y1="19" x2="16" y2="21"/><line x1="16" y1="13" x2="16" y2="15"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="12" y1="15" x2="12" y2="17"/><path d="M20 16.58A5 5 0 0 0 18 7h-1.26A8 8 0 1 0 4 15.25"/></svg>;
const IconSnow    = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><line x1="12" y1="2" x2="12" y2="22"/><path d="m20 6-8 4-8-4m0 8 8 4 8-4"/></svg>;
const IconSunrise = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>;
const IconSunset  = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M17 18a5 5 0 0 0-10 0"/><line x1="12" y1="9" x2="12" y2="2"/><line x1="4.22" y1="10.22" x2="5.64" y2="11.64"/><line x1="1" y1="18" x2="3" y2="18"/><line x1="21" y1="18" x2="23" y2="18"/><line x1="18.36" y1="11.64" x2="19.78" y2="10.22"/></svg>;
const IconGlobe   = () => <svg width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>;
...
export default function App() {
  ...
  const [history, setHistory]     = useState(() => {
    try { return JSON.parse(localStorage.getItem('wx-history') || '[]'); } catch (_e) { return []; }
  });
  const [favorites, setFavorites] = useState(() => {
    try { return JSON.parse(localStorage.getItem('wx-favs') || '[]'); } catch (_e) { return []; }
  });
    ...
    <div className={`app ${sky}`}>
      <div className="app-inner">
        ...
        <header className="header">
          <span className="brand-name">Sky<em>cast</em></span>
            ...
            <div className="dropdown" role="listbox" aria-label="Search suggestions">
              {favorites.length > 0 && (
                <div className="drop-group">
                  <span className="drop-label">Saved</span>
                  {favorites.map(c => (
            ...
            <div className="hero">
              <div className="hero-head">
                ...
                <button className={`fav-btn${isFav ? ' fav-on' : ''}`} onClick={toggleFav}
                  aria-label={isFav ? `Remove ${weather.name} from favorites` : `Save ${weather.name}`}
                  title={isFav ? 'Remove from saved' : 'Save city'}>
              ...
              <div className="stats-grid">
                <div className="stat"><IconDroplet /><span className="stat-val">{weather.main.humidity}%</span><span className="stat-lbl">Humidity</span></div>
                <div className="stat"><IconWind /><span className="stat-val">{weather.wind.speed} {windUnit}</span><span className="stat-lbl">Wind · {windDir(weather.wind.deg)}</span></div>
                <div className="stat"><IconEye /><span className="stat-val">{(weather.visibility / 1000).toFixed(1)} km</span><span className="stat-lbl">Visibility</span></div>
                <div className="stat"><IconGauge /><span className="stat-val">{weather.main.pressure} hPa</span><span className="stat-lbl">Pressure</span></div>
                <div className="stat"><IconCloud /><span className="stat-val">{weather.clouds?.all ?? '—'}%</span><span className="stat-lbl">Cloud Cover</span></div>
                {aqi && (
                  <div className="stat"><IconAir /><span className={`stat-val ${AQI_CLASS[aqi]}`}>{AQI_LABEL[aqi]}</span><span className="stat-lbl">Air Quality</span></div>
                )}
                {weather.rain?.['1h'] != null && (
                  <div className="stat"><IconRain /><span className="stat-val">{weather.rain['1h'].toFixed(1)} mm</span><span className="stat-lbl">Rain (1h)</span></div>
                )}
                {weather.snow?.['1h'] != null && (
                  <div className="stat"><IconSnow /><span className="stat-val">{weather.snow['1h'].toFixed(1)} mm</span><span className="stat-lbl">Snow (1h)</span></div>
                )}
              </div>

              <div className="sun-bar">
                <div className="sun-item"><IconSunrise /><span>Sunrise</span><strong>{fmtTime(weather.sys.sunrise, weather.timezone)}</strong></div>
                <div className="sun-line" />
                <div className="sun-arc"><div className="sun-dot" /></div>
                <div className="sun-line" />
                <div className="sun-item"><IconSunset /><span>Sunset</span><strong>{fmtTime(weather.sys.sunset, weather.timezone)}</strong></div>
              </div>
            </div>
        ...
        {!weather && !loading && !error && (
          <div className="empty-state" aria-label="No city searched yet">
            ...
            <p className="es-sub">Live weather · Hourly · Air quality</p>
          </div>
        )}
